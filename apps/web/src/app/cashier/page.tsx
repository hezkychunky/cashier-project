...
export default function Cashier() {
  ...
  return (
    <div className="flex min-h-screen pl-14">
      <section className="w-3/4 bg-white shadow-xl p-4 rounded-lg ml-4 overflow-y-auto">
      ...
      <section className="w-1/4 bg-white shadow-xl p-4 rounded-lg overflow-y-auto">
